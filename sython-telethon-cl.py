...
try:
    ...
    api_id = "❖ Inter Your App ID ➜  "
    print('  ')
    api_hash = "❖ Inter Your App HASH ➜  "
    print('  ')
    bot_token = "❖ Inter Your Token ➜  "
    print('  ')
    DEVLOO = "❖ Inter Id Off Controller Account ➜  "
    print('  ')
    MAX_ACCOUNTS = "❖ Inter Num Of Max Acc ➜  "
    print('  ')
    user_bot = "❖ Inter Your user bot ➜ "
    print('  ')
    id_bot = "❖ Inter id bot ➜  "
    print('  ')
